        ...
        {places.map((p, i) => (
          <Marker key={i} position={[p.lat, p.lon]}>
            <Popup>
              ...
              {p.type && (
                <div style={{ color: 'var(--text-muted)', fontSize: '0.78rem', marginTop: 2, textTransform: 'capitalize' }}>
                  {p.type}
                </div>
              )}
              {p.address && (
              ...
              <a
                ...
                style={{ color: 'var(--text-h1)', fontSize: '0.78rem', display: 'block', marginTop: 6, fontWeight: 600 }}
              >
