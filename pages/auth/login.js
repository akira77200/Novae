    ...
    <div style={{ minHeight: '100vh', background: C.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, fontFamily: 'system-ui,sans-serif' }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, color: C.muted }}>{lang === 'fr' ? 'Bienvenue sur Novae' : 'Welcome to Novae'}</p>
        </div>
        ...
        <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 16, padding: '28px 28px 24px' }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ textAlign: 'right', marginTop: 8, marginBottom: 20 }}>
              <Link href="/auth/forgot-password" style={{ fontSize: 12, color: C.muted, textDecoration: 'none' }}>
                {t.login_forgot}
              </Link>
            </div>
          ...
          <p style={{ textAlign: 'center', fontSize: 13, color: C.muted, marginTop: 20 }}>
            {t.login_no_account}{' '}
            <Link href="/auth/register" style={{ color: C.accent2, fontWeight: 600, textDecoration: 'none' }}>
              {t.login_signup}
            </Link>
          </p>
        </div>
