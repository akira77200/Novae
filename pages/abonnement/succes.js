      ...
      <main style={{ maxWidth:560, margin:'0 auto', padding:'80px 20px', textAlign:'center' }}>
        ...
        {error ? (
          ...
          <div>
            ...
            <a href="/dashboard" style={{ display:'inline-block', padding:'14px 32px', borderRadius:12, background:'#0E1116', color:'#fff', fontWeight:700, fontSize:15, textDecoration:'none' }}>
