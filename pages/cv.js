...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    h1 { font-size: 20pt; color: #0E1116; margin-bottom: 4px; }
    h2 { font-size: 11pt; color: #0E1116; text-transform: uppercase; letter-spacing: 0.08em; border-bottom: 1px solid #0E1116; padding-bottom: 3px; margin: 14px 0 8px; }
    .poste { color: #0E1116; font-size: 12pt; font-weight: 600; }
    .contact { display: flex; gap: 16px; font-size: 9pt; color: #555; flex-wrap: wrap; margin-top: 6px; }
    .header { border-bottom: 2px solid #0E1116; padding-bottom: 12px; margin-bottom: 16px; }
    .exp-header { display: flex; justify-content: space-between; }
    .exp-titre { font-weight: bold; font-size: 10.5pt; }
    .exp-duree { font-size: 9pt; color: #888; }
    .exp-entreprise { color: #0E1116; font-size: 9.5pt; margin-bottom: 3px; }
    ...
    .comp-titre { color: #0E1116; font-weight: bold; }
                ...
                <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 14, padding: '20px 22px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
                    ...
                    <button onClick={() => copierTexte(aiData.resume_professionnel, 'resume')}
                      style={{ padding: '5px 12px', background: copied === 'resume' ? '#3A3D4020' : '#0E111612', border: `1px solid ${copied === 'resume' ? '#3A3D40' : '#0E1116'}30`, borderRadius: 7, color: copied === 'resume' ? '#3A3D40' : '#3A3D40', fontSize: 12, cursor: 'pointer', fontWeight: 600 }}>
                        ...
                        <div key={i} style={{ padding: '14px 16px', background: 'var(--bg-subtle)', borderRadius: 10 }}>
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 10, marginBottom: 10 }}>
                            ...
                            <button onClick={() => copierTexte(bulletsText, blockId)}
                              style={{ padding: '4px 10px', background: copied === blockId ? '#3A3D4020' : '#0E111612', border: `1px solid ${copied === blockId ? '#3A3D40' : '#0E1116'}30`, borderRadius: 7, color: copied === blockId ? '#3A3D40' : '#3A3D40', fontSize: 11, cursor: 'pointer', fontWeight: 600, flexShrink: 0 }}>
