        ...
        <div style={{ opacity:anim?0:1, transition:'opacity 0.18s' }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:10, marginBottom:24 }}>
            {options.map((opt, i) => {
              ...
              if (showResult) {
                if (isCorrect)                    { bg = 'rgba(52,211,153,0.12)'; border = '#3A3D40'; color = '#3A3D40' }
                else if (isSelected && !isCorrect){ bg = 'rgba(248,113,113,0.12)'; border = '#DC2626'; color = '#DC2626' }
                else                              { bg = '#FFFFFF'; border = '#EBEBE9'; color = '#6B6F76' }
              } else if (isSelected) {
